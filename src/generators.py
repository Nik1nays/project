def filter_by_currency(list_trans, currency):
    """
    Функция, которая принимает на вход список словарей, представляющих транзакции.
    В соответствии с указанной валютой
    """
...
def transaction_descriptions(trans_list):
    """
...
def card_number_generator(start, stop):
    """
    Функция генерирует номер карты в заданом диапазоне
    """
